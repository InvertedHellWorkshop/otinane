 ...
 */
public class ObjectFormBookDoneTestAAFailTest {
    ...
    public void BookFail(){
        ...
        driver.findElement(By.id("userAnswer")).click();
        driver.findElement(By.id("userAnswer")).clear();
        driver.findElement(By.id("userAnswer")).sendKeys("pardalokatsiki");
